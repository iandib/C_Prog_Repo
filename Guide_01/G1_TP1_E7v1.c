...
- MASK2 para verifica que los bits 2 y 6 estén apagados (0x44 correponde a 0100 0100b).
*/
...
int main (void){
   ...
   /* 
    ...
    Para imprimir los valores contrarios solo fue necesario cambiar los operandos 2 y 3 de lugar en el operador condicional.
	*/

	printf("%d\n",(((porta & MASK1) == MASK1) || (((porta & MASK2) == 0)))? 0 : 1);
