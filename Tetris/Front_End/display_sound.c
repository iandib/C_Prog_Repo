...
#define GAME "..Sounds/music1.wav"
#define LINE "..Sounds/burn.wav"
#define LOSE "..Sounds/gameOver.wav"
...
static void allegroInitializeSprites(SPRITES* sprites)								// Initializes image addon and grabs all of the sprites
{
    ...
    sprites->_sheet = al_load_bitmap("../Menu/spritesheet.png");
...
static void allegroInitializeSound(void)											// Initializes audio addon and reserves samples
{
    ...
    ALLEGRO_SAMPLE* burnSFX = al_load_sample("..Sounds/burn.wav");							//Initializes all the samples, one by one.
    checkInitialization(burnSFX, "burn");
    ALLEGRO_SAMPLE* tetrisSFX = al_load_sample("..Sounds/tetris.wav");
    checkInitialization(tetrisSFX, "tetris");
    ALLEGRO_SAMPLE* moveSidewaysSFX = al_load_sample("..Sounds/moveSideways.wav");
    checkInitialization(moveSidewaysSFX, "move sideways");
    ALLEGRO_SAMPLE* rotateSFX = al_load_sample("..Sounds/rotate.wav");
    checkInitialization(rotateSFX, "rotate");
    ALLEGRO_SAMPLE* fixSFX = al_load_sample("..Sounds/fix.wav");
    checkInitialization(fixSFX, "fix");
    ALLEGRO_SAMPLE* gameOverSFX = al_load_sample("..Sounds/gameOver.wav");
    checkInitialization(gameOverSFX, "game over");
    ALLEGRO_SAMPLE* victorySFX = al_load_sample("..Sounds/victory.wav");
    ...
    allegro->music = al_load_audio_stream("..Sounds/music1.wav", 2, 2048);					//Loads the backround music in the audio stream, plays it in loop, and attaches it to the default mixer
